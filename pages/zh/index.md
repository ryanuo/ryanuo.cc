...
keywords: RYANUO, 嵌入式, AI, 工程师, Linux, C语言, C++, ARM, Python, 机器学习, 系统编程, 个人项目, 技术探索, GitHub, Twitter, YouTube, Instagram, 哔哩哔哩, 知乎, 微信
image: /home.png
avatars: /avatar.png
plum: true
id: ryanuo
...
嘿，我是 ryanuo（/rweɪ ˈɑn nɔː/），一名正在从前端开发转向嵌入式系统与人工智能领域的工程师。

目前，我正处于技术转型阶段，逐步从 Web 前端走向更底层的系统开发与智能化方向，专注于嵌入式开发与 AI 技术的学习与实践。

我正在系统学习的技术包括嵌入式 C / C++、Linux 系统编程、ARM 架构基础，同时也在接触 Python 在 AI 领域的应用，以及机器学习与模型部署的基础流程。

在过去的几年中，我主要从事前端开发工作（React、Vue、TypeScript 等），参与过多个复杂的财务中后台项目开发，并积累了较强的工程能力、系统思维以及复杂业务拆解能力。这些能力正在逐步迁移到嵌入式与 AI 方向的学习与实践中。
